    ...
    var body: some View {
        LazyHStack {
            ...
            VStack(alignment: .leading, spacing: 20) {
                ...
                Text("Dr. Pairoj Pittayamatee")
                    .font(.title.bold())
                Text("The inspiration for creating an innovative Thaitone color system by Dr. Pairoj Pittayamatee occurred during the time when Dr. Pairoj was studying for a master's degree. Communication Arts While he was analyzing the design elements, ")
                    .font(.title2)
